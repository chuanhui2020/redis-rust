...
impl CommandExecutor {
    ...
    fn do_execute(&self, cmd: Command) -> Result<RespValue> {
        match cmd {
            ...
            Command::HGetEx(key, opt, fields) => executor_hash::execute_h_get_ex(self, key, opt, fields),
            Command::HSetEx(key, seconds, pairs) => executor_hash::execute_h_set_ex(self, key, seconds, pairs),
